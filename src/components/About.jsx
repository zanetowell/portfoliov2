...
const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-[#0a192f] text-gray-300'>
      ...
      <img src={Pfp} alt='' className='rounded-lg my-5 mx-auto border-4 md:max-h-[500px]'/>
